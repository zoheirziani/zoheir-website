        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    main {overflow:scroll;position: relative;border-radius: 6px;box-shadow: 0 16px 24px 2px rgba(0, 0, 0, 0.14), 0 6px 30px 5px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);background: #f3f3f3;margin: -20px 20px 0px 20px;padding: 10px;}
                    a:link,	a:visited {color: #0180AF;text-decoration: underline;}
                    li:hover {background: #ddd;}
                    ul {width:100%;margin: 0px;padding: 0px;list-style: none;}
                    li {margin: 0px;border-bottom: #ddd 1px solid;padding: 10px 5px;}
